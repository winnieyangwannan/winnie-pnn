...
class PNNConvBase(nn.Module, torch_ac_pnn.RecurrentACModel):
    def __init__(self, obs_space, action_space, use_memory=False, use_text=False):
        ...
        self.output_shapes = [16, 32, 64, self.embedding_size, [action_space.n, 1], [action_space.n, 1]]
        self.input_shapes = [3, 16, 32, 64, self.embedding_size, [action_space.n, 1]]
        ...
        if len(self.columns) > 1:
            ...
            for l in range(1, self.n_layers):
                ...
                if l == 4:
                    ...
                    U_cri = self.generate_U(l, self.V_out_shapes[l][1], self.output_shapes[l][1])
                else:
