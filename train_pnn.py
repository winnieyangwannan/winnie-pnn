from comet_ml import Experiment # important to load comet_ml first
import argparse
import time
import datetime
import torch
...
# for visualize training in comet
experiment = Experiment(api_key="xKJHBQgapVGfPIDWc9AYaxN63",
                       project_name=args.comet_project_name, workspace="winnieyangwannan")
# experiment name shown on comet
...
if args.use_pnn == 'True':
    ...
    for i in range(args.n_columns - 1):
        utils.pnn_load_state_dict(acmodel, i, args.pnn_paths[i])
